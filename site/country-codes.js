window.COUNTRY_CALLING_CODES = [
  ...
  ['BM', '+1441'], ['BT', '+975'], ['BO', '+591'], ['BA', '+387'], ['BW', '+267'], ['BV', '+47'],
  ['BR', '+55'], ['IO', '+246'], ['VG', '+1284'], ['BN', '+673'], ['BG', '+359'], ['BF', '+226'],
  ['BI', '+257'], ['KH', '+855'], ['CM', '+237'], ['CV', '+238'], ['BQ', '+599'], ['KY', '+1345'],
  ['TD', '+235'], ['CL', '+56'], ['CN', '+86'], ['CX', '+61'], ['CC', '+61'], ['CO', '+57'],
  ['KM', '+269'], ['CG', '+242'], ['CK', '+682'], ['CR', '+506'], ['CI', '+225'], ['HR', '+385'],
  ['CU', '+53'], ['CW', '+599'], ['CY', '+357'], ['CZ', '+420'], ['DK', '+45'], ['DJ', '+253'],
  ['DM', '+1767'], ['EC', '+593'], ['EG', '+20'], ['SV', '+503'], ['GQ', '+240'], ['ER', '+291'],
  ['EE', '+372'], ['ET', '+251'], ['FK', '+500'], ['FO', '+298'], ['FJ', '+679'], ['FI', '+358'],
  ['FR', '+33'], ['GF', '+594'], ['PF', '+689'], ['TF', '+262'], ['GA', '+241'], ['GM', '+220'],
  ['GE', '+995'], ['DE', '+49'], ['GH', '+233'], ['GI', '+350'], ['GR', '+30'], ['GL', '+299'],
  ['GD', '+1473'], ['GP', '+590'], ['GU', '+1671'], ['GT', '+502'], ['GG', '+44'], ['GN', '+224'],
  ['GW', '+245'], ['GY', '+592'], ['HT', '+509'], ['HM', '+672'], ['HN', '+504'], ['HK', '+852'],
  ['HU', '+36'], ['IS', '+354'], ['IN', '+91'], ['ID', '+62'], ['IR', '+98'], ['IQ', '+964'],
  ['IE', '+353'], ['IM', '+44'], ['IL', '+972'], ['IT', '+39'], ['JM', '+1876'], ['JP', '+81'],
  ['JE', '+44'], ['JO', '+962'], ['KZ', '+7'], ['KE', '+254'], ['KI', '+686'], ['XK', '+383'],
  ...
  ['MS', '+1664'], ['MA', '+212'], ['MZ', '+258'], ['MM', '+95'], ['NA', '+264'], ['NR', '+674'],
  ['NP', '+977'], ['NL', '+31'], ['NC', '+687'], ['NZ', '+64'], ['NI', '+505'], ['NE', '+227'],
  ['NG', '+234'], ['NU', '+683'], ['NF', '+672'], ['KP', '+850'], ['MP', '+1670'], ['NO', '+47'],
  ['OM', '+968'], ['PK', '+92'], ['PW', '+680'], ['PS', '+970'], ['PA', '+507'], ['PG', '+675'],
  ['PY', '+595'], ['PE', '+51'], ['PH', '+63'], ['PN', '+64'], ['PL', '+48'], ['PT', '+351'],
  ['PR', '+1'], ['QA', '+974'], ['RE', '+262'], ['RO', '+40'], ['RU', '+7'], ['RW', '+250'],
  ['BL', '+590'], ['SH', '+290'], ['KN', '+1869'], ['LC', '+1758'], ['MF', '+590'], ['PM', '+508'],
  ['VC', '+1784'], ['WS', '+685'], ['SM', '+378'], ['ST', '+239'], ['SN', '+221'], ['RS', '+381'],
  ['SC', '+248'], ['SL', '+232'], ['SG', '+65'], ['SX', '+1721'], ['SK', '+421'], ['SI', '+386'],
  ['SB', '+677'], ['SO', '+252'], ['ZA', '+27'], ['GS', '+500'], ['KR', '+82'], ['SS', '+211'],
  ['ES', '+34'], ['LK', '+94'], ['SD', '+249'], ['SR', '+597'], ['SJ', '+47'], ['SZ', '+268'],
  ['SE', '+46'], ['CH', '+41'], ['SY', '+963'], ['TW', '+886'], ['TJ', '+992'], ['TZ', '+255'],
  ['TH', '+66'], ['TL', '+670'], ['TG', '+228'], ['TK', '+690'], ['TO', '+676'], ['TT', '+1868'],
  ['TN', '+216'], ['TR', '+90'], ['TM', '+993'], ['TC', '+1649'], ['TV', '+688'], ['VI', '+1340'],
  ['UG', '+256'], ['UA', '+380'], ['GB', '+44'], ['US', '+1'], ['UM', '+1'], ['UY', '+598'],
  ['UZ', '+998'], ['VU', '+678'], ['VA', '+39'], ['VE', '+58'], ['VN', '+84'], ['WF', '+681'],
